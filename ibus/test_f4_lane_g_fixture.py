...
The operator's 45-word Bulgarian flow is kept as a PARTITIONED diagnostic
...
the operator's probe.  The flow has 55 Space-separated tokens (43 distinct
words); "45-word" is the operator's own count and is kept as the name only.
...
FLOW = (
    "статия за smartkey но по далеч от традиционно представяне огледай и "
    "останалите статии за други проекти темплейтът е сай-фай бекграунд и "
    "представяне на топ фичъри решаващи най-болезнени проблеми на аудиторията "
    "кореспондиращи със северната звезда на проекта всички чупки в този текст "
    "са проблем на smartkey изписване на но като отрицание на български фичъри "
    "и тн"
).split()
...
PARTITIONS: dict[str, tuple[int, ...]] = {
    ...
    "probe_artefact_hyphen": (19, 27),  # сай-фай, най-болезнени
