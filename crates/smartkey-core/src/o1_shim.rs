//! O1 live-run shim — pure ngram-component snapshot.
//!
//! Semantics mirror `phase_a/freqmodel.py` (the frozen lab p-source) exactly:
//!
//! ```text
...
//! code is reachable from this module (scope firewall, `phase_a/constants.py`
//! `PREDICTION_SCOPE = "ngram_component"`).
//!
//! Design artifact (Δ2/Δ3 frozen): `docs/O1-SHIM-DESIGN-2026-07-19.md`.
...
pub struct O1Numbers {
    ...
    /// `latency_us`, which is measured adapter-side per Δ2).
